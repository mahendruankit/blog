    ...
    articles: [
      {
        ...
        date: '01/03/2021',
        minutes: '10',
        thumbnail: imageResource.technologyThumbnails.S1,
        image: '',
        content:
      ...
      },
      {
        ...
        date: '03/01/2021',
        minutes: '15',
        thumbnail: imageResource.technologyThumbnails.S3,
        image: '',
        content:
          'The super-rich - many of whom have multiple homes, private jets and superyachts - emit a lot more than others. A recent study that tracked the air travel of celebrities via their social media accounts found some emitted over a thousand tonnes a year. But the global 1% are not just billionaires, or even millionaires - it includes anyone earning over $172,000.This study also looked at the worlds richest 10% - anyone earning over $55,000 - and found emissions were still high. The richest 10% will emit nine times more carbon than their share.',
    ...
    articles: [
      {
        ...
        date: '01/01/2021',
        minutes: '10',
        thumbnail: imageResource.technologyThumbnails.M1,
        image: '',
        content:
      ...
      },
      {
        ...
        date: '02/01/2021',
        minutes: '7',
        thumbnail: imageResource.technologyThumbnails.M2,
        image: '',
        content:
          'The concept of Horrible Histories needs no introduction (if it does, think history told through the eyes of a toilet-obsessed six-year-old) and the popular CBBC kids show reaches the big-screen with ‘Rotten Romans’. This film documents how the Romans invaded Britain, quelled a Celt rebellion, and introduced public sanitation.The cast is spectacular, with everyone from a comically evil Kim Cattrall to Kate Nash as warrior queen Boudicca, plus Lee Mack, Sir Derek Jacobi, Alexander Armstrong, and Sanjeev Bhaskar popping up in all manner of roles. We particularly enjoyed Craig Roberts as Emperor Nero and Nick Frost as Arghus but if you blink, you’ll miss another British star. Not for refined tastes, but perfect for younger viewers — an entertaining all-rounder with some decent jokes (“We’re going to have to limit your scroll-time!”).',
      ...
      },
      {
        ...
        date: '04/01/2021',
        minutes: '3',
        thumbnail: imageResource.technologyThumbnails.M4,
        image: '',
        content:
    ...
    articles: [
      {
        ...
        date: '01/04/2021',
        minutes: '4',
        thumbnail: imageResource.technologyThumbnails.F1,
        image: '',
        content:
      ...
      },
      {
        ...
        date: '02/04/2021',
        minutes: '5',
        thumbnail: imageResource.technologyThumbnails.F2,
        image: '',
        content:
      ...
      },
      {
        ...
        date: '02/04/2021',
        minutes: '15',
        thumbnail: imageResource.technologyThumbnails.F3,
        image: '',
        content:
      ...
      },
      {
        ...
        date: '04/04/2021',
        minutes: '2',
        thumbnail: imageResource.technologyThumbnails.F4,
        image: '',
        content:
    ...
    articles: [
      {
        ...
        date: '01/05/2021',
        minutes: '2',
        thumbnail: imageResource.technologyThumbnails.FD1,
        image: '',
        content:
      ...
      },
      {
        ...
        date: '02/05/2021',
        minutes: '3',
        thumbnail: imageResource.technologyThumbnails.FD2,
        image: '',
        content:
          'The Food Standards Agency has told ITV News that new rules are needed over environmental labelling, as concerns are raised about the inconsistency in the way products are currently being displayed.The majority of manufacturers do not know or do not show their products carbon footprint, with many consumers potentially believing a "carbon neutral" label means there is no carbon footprint involved in the manufacturing process- which is often not the case. As the COP26 climate summit draws to the end of its first week in Glasgow, new research from OnePoll survey shows 70% of shoppers want more environmental information.',
      ...
      },
      {
        ...
        date: '02/01/2021',
        minutes: '15',
        thumbnail: imageResource.technologyThumbnails.FD3,
        image: '',
        content:
          'Eight Nottinghamshire restaurants feature in the highly anticipated AA Restaurant Guide 2022. These restaurants are all featured in the AAs guide, which has just been released and gives readers an idea of the best places to visit across the country if they want a meal out. All of these restaurants received at least one coveted AA rosette, awarded to outstanding restaurants and hotels since 1956. To receive just one Rosette is a rare honour, according to the AAs Restaurant Guide : "Of all the restaurants across the UK, approximately 10% are of a standard worthy of 1 Rosette and above.',
